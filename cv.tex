...
\begin{entrylist}
  ...
  \entry
    ...
    {%ASK-AR - Analysis of Social Knowledge\\
     \langif{br}{Sócio-Diretor de tecnologia, com foco principal em tecnologias para coleta, tratamento, análise e visualização de dados.}{CTO with main focus on technologies related to data extraction, gathering, treatment, analysis and visualization.)}\\
