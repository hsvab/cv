...
~
    ...
    {\Large\textcolor{gray}{\Letter}} \hfill \href{mailto:diraol@usp.br}{diraol@usp.br}
~
...
\begin{entrylist}
  \entry
    ...
    {\langif{br}{
         Com a fusão, e após os avanços da unificação das plataformas, passei a
         trabalhar no time de Engenharia de Sistemas (Systems Engineering),
       }{
         With the advances of the platforms unification, I joined the Systems
         Engineering team,
       } \\ %
     \maintechs
     K8s, Nomad, Docker, Prometheus, Grafana, Ansible, Terraform, Gitlab, \eand
     GCloud.
     \hfill%
  ...
  \entry
    ...
    {\langif{br}{
         ...
         Responsible for EasyTaxi Data Engineering team. Management and
         development of data pipelines, Data Lake and Data Warehouse. Close
         contact with many internal stakeholders, such as Data Scientists,
         Business Analysts, Development teams, Operational teams, among others.
         Also worked with the integration between EasyTaxi and Cabify
         integration.
       } \\ %
     \maintechs
  ...
  \entry
    ...
    {\langif{br}{
         Consultoria com foco em dados e tecnologias.
       }{
         Consultancy focused in data and technology.
       }%
     \hfill%
